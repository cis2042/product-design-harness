...
`.agents/skills/product-design-harness/` の完全な bundle を install してから
...
agent に接続するときは `.agents/skills/product-design-harness/SKILL.md` を読み込み、
...
| Path | 目的 |
|---|---|
| `.agents/skills/product-design-harness/SKILL.md` | 完全な runtime resources を含む installable skill entrypoint。 |
| `SKILL.md` | repository 読者向けの source contract。installer はこれを除外して完全な bundle を選びます。 |
